...
| R6 | Row fidelity: wrapped descriptions + column debris | P0 | R1, R2 | M | [ ] |
| W1 | Whole-doc budget honesty | P1 | — | M | [ ] |
| W2 | Doc-count fallthrough routing + plausibility gate | P1 | W1 | M | [ ] |
| W3 | Third mode (LLM over extracted data) — seam + invoice | P1 | R2 | L | [ ] |
| W4 | Third mode — bank port + format parity + follow-ups | P1 | W3 | M | [ ] |

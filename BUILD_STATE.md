...
Branch `image-understanding`, implementing `docs/image-understanding-plan.md` §16
...
Branch `image-understanding`, implementing `docs/image-understanding-plan.md`
...
Branch `image-understanding`, implementing the (V1-cleared) `docs/image-understanding-plan.md`
...
`docs/image-understanding-plan.md` to fix **every finding** of the
...
Branch `context-window-compaction`. Implementing `docs/context-compaction-plan.md`
...
`docs/brand-refresh-plan.md` phase BR5 of BR1–BR6 (WORKING PAPER — BR6 next,
...
`docs/brand-refresh-plan.md` phase BR2 of BR1–BR6 (WORKING PAPER — BR3
...
rewritten.** Branch `design-adjustments`; plan `docs/brand-refresh-plan.md`
...
`docs/full-doc-skills-plan.md` Phase 3 of 4 (still a working paper —
...
`docs/full-doc-skills-plan.md` Phase 2 of 4 (still a working paper —
...
Branch `fix-use-full-doc-for-skills`; plan `docs/full-doc-skills-plan.md`
...
`docs/skills-s11-plan.md` was authored + the scope cut RATIFIED by the owner
...
_**Skills — OWNER DECISION REVISION (2026-06-17), folded into `docs/skills-plan.md`
...
**Phase 0 (ratified before code):** authored `docs/skills-s11-plan.md` — the
...
`docs/skills-plan.md`: local, user-installable
...
Third phase of `docs/whole-document-analysis-plan.md` (§6 Phase 3;
...
provenance UI).** Second phase of `docs/whole-document-analysis-plan.md`
...
summary tree).** First phase of `docs/whole-document-analysis-plan.md`
...
non-silent).** Sixth and final v1 phase of `docs/document-organization-plan.md`

...
21. **ZIM knowledge packs — follow-up register (registered at the 2026-09-04 MVP; durable
    ...
    accepted deviation: the ScopePopover is non-modal (design-guidelines §11.15 decision 1, P6); T18-b — RECORDED 2026-09-06 (run by the orchestrator at the owner's request in real Electron against the real packs; rag-design §17 "Real acceptance" → "T18-b"; it surfaced T19 finding 3: kiwix-serve 3.8.1 win-x86_64 never answers ~5–20 % of large /raw reads — upstream, mitigated by the P7 fix PR 2, upstream report on #339); T19 the owner's Electron/drive legs (relocated

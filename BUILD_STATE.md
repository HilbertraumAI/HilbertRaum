...
_2026-09-06 — **PR #308 audit remediation (`feat/vram-aware-picker`, stacked on #303):** R1–R6 closed in
five phases — P1 sync (`7aae2716`), P2 budget device + next-start class (`81661c69`), P2a empty-probe
persistence (`8cb4422d`), P3 rule C on the free-memory budget + per-model cache term (`bf9a09b0`),
P4 live Performance recommendation (`a468f6e1`), P5 records (`e4b762e9`); base re-merged twice
(`36f581c7`, `79e5179e`, the second unifying #303 P5's `gpu-rules` with this wave's helper). Decisions
1–11 adopted; record `model-benchmarks.md` §6.6 (2026-09-06 amendment) + §6.5. Owner sign-off
(§6.5/§6.6) requested in PR review. Hardware legs → #318 (not a merge gate, G3); owner calls
(h)–(k) → #320 / #319 / #320 / #321; residuals #322–#327._

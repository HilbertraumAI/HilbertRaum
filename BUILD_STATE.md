...
**Phase log** (one line per phase — the retention budget is tight, so this wave keeps ONE dated entry instead of one per phase): P0 wave open — branch created, working papers committed verbatim, baseline recorded.

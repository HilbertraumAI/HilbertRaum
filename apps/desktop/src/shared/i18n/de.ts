...
export const de: Record<keyof typeof en, string> = {
  ...
  // Updates-Bildschirm (untere Utility): schlanke UI über der Control-API des Launchers.
  'updates.title': 'Updates',
  'updates.subtitle':
    'Nach HilbertRaum-Updates suchen und sie installieren. Alles läuft lokal über den Laufwerks-Launcher – kein Konto, keine Telemetrie.',
  'updates.mockWarning':
    'Demomodus: Der Update-Dienst läuft nicht (die App wurde nicht vom Laufwerks-Launcher gestartet), daher zeigt diese Seite simulierte Updates. Auf einem echten Laufwerk kommuniziert sie mit dem Launcher.',
  'updates.version': 'Installierte Version {version}',
  'updates.readyBanner': 'Version {version} wurde heruntergeladen und ist installationsbereit.',
  'updates.failedBanner': 'Update fehlgeschlagen: {message}',
  'updates.downloadLabel': 'Lade {done} von {total} Dateien · {doneMb} / {totalMb} MB · {rate}',
  'updates.installLabel': 'Installiere {done} von {total} Dateien · {doneMb} / {totalMb} MB',
  'updates.state.idle': 'Bereit',
  'updates.state.checking': 'Suche',
  'updates.state.downloading': 'Lädt',
  'updates.state.ready': 'Installationsbereit',
  'updates.state.applying': 'Installiere',
  'updates.state.failed': 'Fehlgeschlagen',
  'updates.check': 'Nach Updates suchen',
  'updates.checking': 'Suche…',
  'updates.install': 'Installieren und neu starten',
  'updates.applyNote': 'Beim Installieren wird HilbertRaum geschlossen und neu gestartet.',

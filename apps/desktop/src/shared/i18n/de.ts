...
export const de: Record<keyof typeof en, string> = {
  ...
  'chat.list.viewAria': 'Unterhaltungsansicht',
  'chat.list.viewRecent': 'Zuletzt',
  'chat.list.viewByProject': 'Nach Projekt',
  'chat.folder.move': 'In Ordner verschieben',
  'chat.folder.new': 'Neuer Ordner…',
  'chat.folder.newChatHere': 'Neue Unterhaltung in diesem Ordner',
  'chat.folder.files': 'Dateien dieses Ordners öffnen',
  'chat.folder.back': 'Zurück zu den Ordnern',
  'chat.folder.empty': 'Noch keine Unterhaltungen in diesem Ordner.',
  'chat.folder.remove': 'Aus Ordner entfernen',
  'chat.folder.newTitle': 'Neuer Ordner',
  'chat.folder.nameAria': 'Ordnername',
  'chat.folder.namePlaceholder': 'Ordnername',
  ...
  'diag.audit.collection_moved': 'Projekt verschoben',

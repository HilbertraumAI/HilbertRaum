...
export const de: Record<keyof typeof en, string> = {
  ...
  'home.packs.label': 'Wissenspakete',
  'home.packsReady.one': '{count} Wissenspaket bereit für deine Fragen',
  'home.packsReady.other': '{count} Wissenspakete bereit für deine Fragen',
  'home.packs.none': 'Noch keine Pakete — füge eine Offline-Wikipedia hinzu, um allgemeine Fragen zu stellen',
  'home.packs.noneReady': 'Kein Paket ist bereit für Fragen — sieh unter Dokumente nach',
  'home.packs.badgeNoneReady': 'Keines bereit',
  'home.packs.add': 'Pakete hinzufügen',
  'home.packs.open': 'Wissenspakete öffnen',
  ...
  // #382 — siehe en.ts.
  'models.verifyAll': 'Alle Modelldateien prüfen',
  'models.verifyingAll': 'Alle Modelldateien werden geprüft…',
  'models.verifyAllTitle':
  ...
  'docs.mode.aria': 'Ansicht der Dokumente',
  'docs.mode.documents': 'Meine Dokumente',
  'docs.mode.packs': 'Wissenspakete',
  'docs.filter.placeholder': 'Nach Name filtern…',
  'docs.filter.aria': 'Dokumente nach Name filtern',
  'docs.filter.noMatch': 'Kein Dokument passt zu „{query}“.',
  'docs.empty.packsLine': 'Oder füge ein Wissenspaket hinzu — eine Offline-Wikipedia, aus der der Chat antworten kann.',
  'docs.empty.packsAction': 'Wissenspakete',
  ...
  'docs.smart.attention': 'Braucht Aufmerksamkeit',
  'docs.smart.attentionTitle': 'Fehlgeschlagene Importe und Dokumente, die neu aufbereitet werden müssen',
  ...
  'packs.lead': 'Offline-Nachschlagewerke (ZIM-Dateien, zum Beispiel eine Offline-Wikipedia), aus denen der Chat antworten kann. Dateien werden an Ort und Stelle genutzt und nie kopiert: Leg sie in den zim-Ordner des Laufwerks oder füge sie hier hinzu.',
  'packs.summary.count.one': '{count} Paket',
  'packs.summary.count.other': '{count} Pakete',
  'packs.summary.enabled.one': '{count} aktiv',
  'packs.summary.enabled.other': '{count} aktiv',
  'packs.summary.size': '{size} auf diesem Laufwerk',
  ...
  'packs.emptyLine': 'Lade ein einteiliges .zim-Archiv von library.kiwix.org herunter und füge es hier hinzu oder kopiere es in den zim-Ordner des Laufwerks.',
  'packs.copyLibrary': 'Adresse der Bibliothek kopieren',
  'packs.copiedToast': 'library.kiwix.org kopiert',
  'packs.copyFailed': 'Kopieren nicht möglich – die Adresse lautet library.kiwix.org',
  'packs.setup.title': 'Einmalige Einrichtung: die Wissenspaket-Werkzeuge',
  ...
  'packs.addFailed.toolsMissing': 'Die kiwix-tools-Programme sind auf diesem Laufwerk nicht installiert; Pakete können daher nicht hinzugefügt oder durchsucht werden. Der Installationsschritt steht in der Fehlerbehebung unter „Das Panel meldet, dass kiwix-tools fehlen“.',
  ...
  'packs.switchLabel': '{title} in Chats nutzen',
  'packs.ask': 'Dieses Paket fragen',
  'packs.askTitle': 'Einen Chat öffnen, der nur aus diesem Paket antwortet',
  'packs.rowMenu': 'Weitere Aktionen für {title}',

...
export const en = {
  ...
  'diag.audit.evidence_review_created': 'Evidence review created',
  ...
  'perf.tile.memory.fits': 'Fits {model} with a {context}-token context',
  'perf.tile.memory.gpu': 'GPU: {name}',
  'perf.tile.memory.noGpu': 'no usable GPU',

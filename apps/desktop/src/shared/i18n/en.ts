...
export const en = {
  ...
  'chat.list.viewAria': 'Conversation view',
  'chat.list.viewRecent': 'Recent',
  'chat.list.viewByProject': 'By Project',
  'chat.folder.move': 'Move to folder',
  'chat.folder.new': 'New folder…',
  'chat.folder.newChatHere': 'New chat in this folder',
  'chat.folder.files': 'Open this folder’s files',
  'chat.folder.back': 'Back to folders',
  'chat.folder.empty': 'No conversations in this folder yet.',
  'chat.folder.remove': 'Remove from folder',
  'chat.folder.newTitle': 'New folder',
  'chat.folder.nameAria': 'Folder name',
  'chat.folder.namePlaceholder': 'Folder name',
  ...
  'chat.skill.run.done.redacted.one': 'Saved a redacted copy — {count} item hidden. Review it before sharing.',
  'chat.skill.run.done.redacted.other': 'Saved a redacted copy — {count} items hidden. Review it before sharing.',
  ...
  'diag.audit.collection_moved': 'Project moved',

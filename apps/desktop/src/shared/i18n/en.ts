...
export const en = {
  ...
  // Updates screen (bottom utility): thin UI over the loader launcher's control API.
  'updates.title': 'Updates',
  'updates.subtitle':
    'Check for and install HilbertRaum updates. Everything runs locally through the drive launcher — no account, no telemetry.',
  'updates.mockWarning':
    'Demo mode: the update service isn’t running (the app wasn’t started by the drive launcher), so this screen shows simulated updates. On a real drive it talks to the launcher.',
  'updates.version': 'Installed version {version}',
  'updates.readyBanner': 'Version {version} is downloaded and ready to install.',
  'updates.failedBanner': 'Update failed: {message}',
  'updates.downloadLabel': 'Downloading {done} of {total} files · {doneMb} / {totalMb} MB · {rate}',
  'updates.installLabel': 'Installing {done} of {total} files · {doneMb} / {totalMb} MB',
  'updates.state.idle': 'Idle',
  'updates.state.checking': 'Checking',
  'updates.state.downloading': 'Downloading',
  'updates.state.ready': 'Ready to install',
  'updates.state.applying': 'Installing',
  'updates.state.failed': 'Failed',
  'updates.check': 'Check for updates',
  'updates.checking': 'Checking…',
  'updates.install': 'Install and restart',
  'updates.applyNote': 'Installing will close and relaunch HilbertRaum.',

          ...
          <div className="msg-block assistant">
            <div className="msg assistant">
              ...
              {/* The live answer renders Markdown via Streamdown (perf audit FE-1, revisited):
                  ...
                  markers. `.md` applies the same prose CSS as a persisted turn. The visible text is
                  NOT a live region (audit L7) — announcement is delegated to the separate
                  sentence-throttled StreamAnnouncer below. */}
              <div className="msg-content md">
                <AssistantMarkdown text={localizeServerCopy(t, streamText)} streaming />
  ...
  return (
    <Streamdown
      ...
      components={{
        ...
        // inert text, not a link. Inline (not a named component) so it inherits Streamdown's
        // contextual prop typing instead of tripping the strict `Components` index signature.
        a: ({ href, children }) =>
          isSafeHttpUrl(href) ? (
